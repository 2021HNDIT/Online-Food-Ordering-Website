...
<head>
  ...
  <title>Shimi Restaurant</title>

  <!-- Favicons-->
  <link rel="icon" href="images/logo6.png" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="images/logo6.png">
  <!-- For iPhone -->
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/admin.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
...
<table>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><label for="balance">Balance</label><input id="balance" name="'.$row['id'].'balance" value="'.$balance.'" type="number" data-error=".errorTxt01"><div class="errorTxt01"></div></td></tr>'; 					
				}
				?>
                    </tbody>
</table>
...
<table>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Good Food Mood <a class="grey-text text-lighten-4" href="#" target="_blank"></a> </span>
        <span class="right"> Shimi<a class="grey-text text-lighten-4" href="#">Restaurant</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
